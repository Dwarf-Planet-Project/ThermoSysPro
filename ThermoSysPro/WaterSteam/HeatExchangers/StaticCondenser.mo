...
public 
  Connectors.FluidInlet Cee "Cooling water inlet" 
    annotation (extent=[-112,-72; -88,-50]);
  Connectors.FluidOutlet Cse "Cooling water outlet" 
    annotation (extent=[90,-72; 114,-50]);
  Connectors.FluidOutlet Cex "Extraction water" 
    annotation (extent=[-12,-114; 14,-90]);
...
public 
  Connectors.FluidInlet Cep "Drain inlet" 
    annotation (extent=[-112,8; -88,30]);
public 
  Connectors.FluidInlet Cev "Vapor inlet" 
    annotation (extent=[-112,50; -88,72]);
equation 
  ...
  annotation (
    Coordsys(
      ...
      component=[20, 20]),
    Diagram(
      Polygon(points=[100,-82; 100,80; -100,80; -100,-82; 100,-82], style(
      ...
      Text(
        ...
        style(
          ...
          fillColor=42),
        string="Vapor inlet"),
      Line(points=[0,8; 0,-70],   style(
          color=1,
          thickness=4,
          gradient=3,
          fillColor=42)),
      Polygon(points=[0,-90; -11,-70; 11,-70; 0,-90], style(
          color=1,
          thickness=2,
          gradient=3,
          arrow=2,
          fillColor=42)),
      Line(points=[-100,8; 100,8], style(
          color=3,
          rgbcolor={0,0,255},
          thickness=2)),
      Line(points=[-100,-14; 80,-14; 80,-20; -90,-20; -90,-26; 80,-26; 80,-32;
            -90,-32; -90,-38; 100,-38],          style(thickness=2))),
    Icon(
      Polygon(points=[100,-86; 100,80; -100,80; -100,-86; 100,-86], style(
            fillColor=6, rgbfillColor={255,255,0})),
      Line(points=[-100, -14; 80, -14; 80, -20; -90, -20; -90, -26; 80, -26; 80,
             -32; -90, -32; -90, -38; 100, -38], style(thickness=2)),
      Polygon(points=[0,-90; -11,-70; 11,-70; 0,-90], style(
          color=1,
          thickness=2,
          gradient=3,
