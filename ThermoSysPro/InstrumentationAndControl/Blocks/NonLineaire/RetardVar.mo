...
block RetardVar 
  ...
  annotation (
    ...
    fillPattern=0)),
      ...
      Line(points=[-100, -80; -76, -80; 0, -2], style(color=0)),
      Polygon(points=[8, 6; -10, -2; -2, -12; 8, 6], style(color=0, fillColor=0))),
    Diagram(
  ...
  style(color=9)),
      ...
      Line(points=[-100, -80; -70, -80; -70, -48], style(arrow=1))),
    Window(
      x=0.13,
      y=0.22,
      width=0.6,
...
"));
  ...
  ThermoSysPro.InstrumentationAndControl.Connectors.InputReal uRetard 
    annotation (extent=[-120, -90; -100, -70], layer="icon");
equation 
  
  y.signal = delay(u.signal, uRetard.signal, retardMax);
end RetardVar;
