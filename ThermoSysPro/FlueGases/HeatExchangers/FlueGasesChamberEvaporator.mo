...
equation 
  ...
  annotation (Diagram(
            Rectangle(extent=[-80,100; 80,-100], style(
          color=3,
          rgbcolor={0,0,255},
          fillColor=6,
          rgbfillColor={255,255,0},
          fillPattern=8)),
      Rectangle(extent=[-80,100; -74,-100], style(
          color=3,
          rgbcolor={0,0,255},
          fillColor=4,
          rgbfillColor={0,255,255})),
      Rectangle(extent=[-44,100; -36,-100], style(
          color=3,
          rgbcolor={0,0,255},
          fillColor=4,
          rgbfillColor={0,255,255})),
      Rectangle(extent=[36,100; 44,-100], style(
          color=3,
          rgbcolor={0,0,255},
          fillColor=4,
          rgbfillColor={0,255,255})),
      Rectangle(extent=[-4,100; 4,-100], style(
          color=3,
          rgbcolor={0,0,255},
          fillColor=4,
          rgbfillColor={0,255,255})),
      Rectangle(extent=[74,100; 80,-100], style(
          color=3,
          rgbcolor={0,0,255},
          fillColor=4,
          rgbfillColor={0,255,255}))), Icon(
            Rectangle(extent=[-80,100; 80,-100], style(
          color=3,
          rgbcolor={0,0,255},
          fillColor=6,
