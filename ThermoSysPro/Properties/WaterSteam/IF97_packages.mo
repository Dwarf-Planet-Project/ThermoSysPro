...
package IF97_packages 
  ...
  annotation (extent=[-90, 15; -43.3333, 61.6667]);
    protected 
      ThermoSysPro.Properties.WaterSteam.Common.GibbsDerivs 
                   g annotation (extent=[-90, -85; -43.3333, -38.3333]);
      ThermoSysPro.Properties.WaterSteam.Common.HelmholtzDerivs 
                       f 
  annotation (extent=[-23.3333, -85; 23.3333, -38.3333]);
    algorithm 
...
"));
    ...
    public 
      output ThermoSysPro.Properties.WaterSteam.Common.PropThermoSat 
                            lsat annotation (extent=[-85, 15; -15, 85]);
      output ThermoSysPro.Properties.WaterSteam.Common.PropThermoSat 
                            vsat annotation (extent=[15, 15; 85, 85]);
    protected 
      ThermoSysPro.Properties.WaterSteam.Common.GibbsDerivs 
                   gl annotation (extent=[-85, -85; -15, -15]);
      ThermoSysPro.Properties.WaterSteam.Common.GibbsDerivs 
                   gv annotation (extent=[15, -85; 85, -15]);
    algorithm 
...
"));
  ...
  "temperature at phase boundary, using inverse from region 2";
    ...
    protected 
      ThermoSysPro.Properties.WaterSteam.Common.GibbsDerivs3rd 
                                         g 
  "dimensionless Gibbs funcion and dervatives wrt pi and tau"                    annotation (extent=[-90, -85; -43.3333, -38.3333]);
      ThermoSysPro.Properties.WaterSteam.Common.HelmholtzDerivs3rd 
                                             f 
  "dimensionless Helmholtz funcion and dervatives wrt delta and tau" 
  annotation (extent=[-23.3333, -85; 23.3333, -38.3333]);
  ...
  annotation (
    ...
    Icon(
      ...
      Text(
        ...
        string="fonction",
        style(color=45)),
      Ellipse(extent=[-100,100; -60,-100], style(
          color=1,
          rgbcolor={255,0,0},
          fillColor=1,
...
"));
  ...
  ThermoSysPro.Properties.WaterSteam.Common.GibbsData 
    ...
    annotation (extent=[15, 15; 85, 85]);
  ThermoSysPro.Properties.WaterSteam.Common.GibbsDerivs 
                     g annotation (extent=[-85, -85; -15, -15]);
  ThermoSysPro.Properties.WaterSteam.Common.HelmholtzDerivs 
                         f annotation (extent=[15, -85; 85, -15]);
      algorithm 
...
is singular, i.e., no unique solution exists.");
  ...
  annotation (
    Icon(graphics={Polygon(points={{-94,-92},{-68,-66},{-58,-42},{
         -48,2},{-42,22},{-30,36},{-20,42},{-6,44},{6,44},{22,40},{40,26},
         {54,2},{58,-16},{64,-48},{68,-72},{66,-94},{62,-98},{-100,-98},
         {-94,-92}}, lineColor={0,0,255})}));
      end PhaseBoundary;
