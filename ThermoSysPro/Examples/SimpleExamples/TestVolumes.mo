...
model TestVolumes 
  ...
  ThermoSysPro.WaterSteam.Volumes.VolumeA volumeA     annotation (extent=[-50,20; -30,0]);
...
equation 
  ...
  connect(volumeA1.Cs2, valve4.C1)   annotation (points=[-40,-60; -40,-90;
  -10,-90],     style(color=3, rgbcolor={0,0,255}));
  connect(volumeA1.Cs1, valve3.C1)   annotation (points=[-30,-50; -10,-50],
                     style(color=3, rgbcolor={0,0,255}));
  ...
  connect(pipe2.C2, volumeA1.Ce1)    annotation (points=[-60,-50; -50,-50],
                 style(color=3, rgbcolor={0,0,255}));
  connect(volumeA.Cs2, valve1.C1)  annotation (points=[-40,20; -40,70;
  -10,70], style(color=3, rgbcolor={0,0,255}));
  connect(volumeA.Cs1, valve2.C1) 
    annotation (points=[-30,10; -10,10], style(color=3, rgbcolor={0,0,255}));
