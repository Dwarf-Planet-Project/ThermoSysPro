...
equation 
  ...
  connect(volumeD.Cs3, valve2.C1) annotation (points=[-30,10; -10,10], style(
      ...
      rgbcolor={0,0,255},
      smooth=0));
  connect(pipe1.C2, volumeD.Ce) annotation (points=[-60,10; -50,10], style(
      color=3,
      rgbcolor={0,0,255},
      smooth=0));
  connect(volumeD1.Cs3, valve3.C1) annotation (points=[-30,-50; -10,-50], style(
      color=3,
      rgbcolor={0,0,255},
      smooth=0));
  connect(pipe2.C2, volumeD1.Ce) annotation (points=[-60,-50; -50,-50], style(
      color=3,
      rgbcolor={0,0,255},
      smooth=0));
  connect(valve2.C2, volumeB1.Ce2) annotation (points=[10,10; 30,10; 30,-11],
      style(
      color=3,
      rgbcolor={0,0,255},
      smooth=0));
  connect(volumeB1.Cs, valve5.C1) annotation (points=[40,-20; 50,-20], style(
      color=3,
      rgbcolor={0,0,255},
      smooth=0));
  connect(valve3.C2, volumeB1.Ce3) annotation (points=[10,-50; 30,-50; 30,-30],
      style(
      color=3,
      rgbcolor={0,0,255},
      smooth=0));
